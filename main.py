...
for keyValue in range(1,31):
    total = 0
    total=total + Dict.get(keyValue)
...
value = sorted(merged_dictionary.values(), reverse = True)
print(value)

print("Maximum element of the merged dictionary is: ")
maximum=value[0]
print(maximum)

print("Minimum element of the merged dictionary is: ")
minimum=value[-1]
print(minimum)
